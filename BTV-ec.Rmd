...
```{r setwd}
setwd("C:/Users/alfredo.acosta/OneDrive - SVA/Papers/2023/BTV/V4.3.2/")
```
...
# import Quito limits
uio <- st_read(dsn = "C:/Users/alfredo.acosta/OneDrive - SVA/Papers/2023/BTV/V4.3.2/quito.shp")
uio <- st_transform(uio, crs = 4326)

# import GYE limits
gye <- st_read("C:/Users/alfredo.acosta/OneDrive - SVA/Papers/2023/BTV/V4.3.2/guayaquil.shp")
...
source("C:\\Users\\alfredo.acosta\\OneDrive - SVA\\Papers\\2023\\BTV\\V4.3.2\\passthemap_sizse.update.R")  
